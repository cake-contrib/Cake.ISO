...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./Cake.ISO.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./Cake.ISO.sln", new DotNetBuildSettings
    {
...
Task("pack")
    ...
    .Does(() =>
{
    var releaseNotes = $"https://github.com/cake-contrib/Cake.ISO/releases/tag/v{buildVersion.Version}";

    DotNetPack("./src/Cake.ISO/Cake.ISO.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
